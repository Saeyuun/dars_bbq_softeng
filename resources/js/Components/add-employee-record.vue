<template>
  <form @submit.prevent="addEmployee">
    ...
    <div class="mb-4">
      ...
      />
      <p class="text-sm text-gray-500 mt-1">Optional: Upload a profile picture for the employee.</p>
    </div>
...
export default {
  ...
  methods: {
    ...
    onFileChange(event) {
      ...
      if (file) {
        this.newEmployee.profilePicture = URL.createObjectURL(file); 
      }
    },
    ...
    addEmployee() {
      ...
      this.newEmployee = { id: null, name: "", email: "", role: "", contact: "", profilePicture: null };
    },
  },
};
</script>